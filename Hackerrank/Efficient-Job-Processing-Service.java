/*
* Given the max runtime of service, find the max total weight the service can process
* if service processes any tasks in double the task duration
* input: t=[2,2,3,4] w = [2,4,4,5] p=15
*/
import java.io.*;
import java.math.*;
